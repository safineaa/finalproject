...
class Users extends Migration
{
	...
	public function up()
	{
		...
		$this->addColumn('username varchar(15) NULL');
		$this->addColumn('email varchar(50) NULL');
		$this->addColumn('password varchar(100) NULL');
		$this->addColumn('role varchar(15) NULL');
	...
	public function down()
	{
		...
		//if you make more than one table above must put command below here too (57)
	}
